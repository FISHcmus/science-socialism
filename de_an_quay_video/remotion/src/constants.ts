...
export const SECTIONS: SectionDef[] = [
  ...
  { id: "1.1", label: "Ba nguyên tắc cơ bản", member: "Thục Nhi", from: 900, duration: 2700, color: "#FEF3C7" },
  { id: "1.2", label: "Năm đặc trưng ĐĐKTDT", member: "Châu Nhi", from: 3600, duration: 2700, color: "#DBEAFE" },
  { id: "1.3", label: "Bốn nguyên tắc xây dựng", member: "Phụng Nhi", from: 6300, duration: 2700, color: "#F3E8FF" },
  { id: "2.1", label: "Thực tiễn đoàn kết VN", member: "Huỳnh Nhi", from: 9000, duration: 1800, color: "#DCFCE7" },
  { id: "2.2", label: "Thành tựu & con số", member: "Phú", from: 10800, duration: 1800, color: "#FEF9C3" },
  { id: "3.1", label: "Nhận thức đúng đắn", member: "Quỳnh Như", from: 12600, duration: 2700, color: "#FCE7F3" },
  { id: "3.2", label: "Rèn luyện phẩm chất", member: "Tố Như", from: 15300, duration: 2700, color: "#E0F2FE" },
  { id: "3.3", label: "Hoạt động thực tiễn", member: "Ý Như", from: 18000, duration: 2700, color: "#FFF7ED" },
