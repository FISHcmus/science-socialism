...
const CARDS = [
  { title: "4 dấu hiệu tin giả", detail: "1) Tiêu đề giật gân, câu view. 2) Thiếu nguồn uy tín, không trích dẫn. 3) Ảnh/video cắt ghép, lấy sai ngữ cảnh. 4) Quy chụp cả nhóm dân tộc hoặc tôn giáo.", appearAt: 90 },
  { title: "Ví dụ thực tế: Đắk Lắk", detail: "Thông tin bịa đặt về quan hệ dân tộc ở Tây Nguyên lan truyền trên mạng xã hội, gây hoang mang dư luận.", appearAt: 600 },
  { title: "Cách kiểm chứng thông tin", detail: "Đối chiếu nhiều nguồn báo chí uy tín. Dùng Google Image hoặc TinEye tra nguồn ảnh gốc. Chia sẻ đính chính kèm nguồn tin cậy.", appearAt: 1050 },
];
        ...
        <AbsoluteFill style={{ flexDirection: "row" }}>
          <div className="flex flex-col overflow-hidden" style={{ width: 1440, height: 1080, padding: "60px 60px 40px 80px" }}>
            <div className="mb-6" style={{ opacity: headerOpacity }}>
              ...
              <h2 className="text-[52px] text-ds-white font-sans font-bold m-0 leading-tight" style={{ textShadow: TEXT_SHADOW }}>Nhận diện thông tin sai lệch trên mạng xã hội</h2>
          ...
          <div style={{ opacity: pipOpacity }}><MemberPiP name="Hoàng Thị Tố Như" sectionLabel="Phần 3.2 - Nhận diện tin giả" ringAngle={ringAngle} /></div>
        </AbsoluteFill>
      )}
    </AbsoluteFill>
  );
