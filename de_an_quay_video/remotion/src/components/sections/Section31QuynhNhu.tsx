...
export const Section31QuynhNhu: FC = memo(() => {
    ...
    <AbsoluteFill>
      {frame < 360 && (
        <AbsoluteFill className="flex items-center justify-center" style={{ background: "linear-gradient(135deg, rgba(247,243,238,0.97) 0%, rgba(237,232,224,0.95) 100%)" }}>
          <SectionTitle title="Nhận thức đúng đắn" subtitle="Giao lưu văn hóa dân tộc" sectionNumber="PHẦN 3.1" opacity={titleOpacity} translateY={titleTranslateY} accentWidth={titleAccentWidth} scale={titleScale} />
        </AbsoluteFill>
      )}
        ...
        <AbsoluteFill style={{ flexDirection: "column" }}>
          ...
          <div style={{ position: "relative", width: 1920, height: 480, background: "#000", opacity: videoOpacity }}>
            <Sequence from={360} layout="none" durationInFrames={2940}>
              <OffthreadVideo src={staticFile('media/T3-1/video_quynh_nhu_cropped.mp4')} style={{ width: "100%", height: "100%", objectFit: "contain" }} />
            </Sequence>
